...
class Predictor:
    ...
    def _preprocessing(self, data, last_date = None):
        ...
        logger.info("Pré-processamento finalizado. Total de registros: %s [Inicio %s : Fim %s]", len(df), ds_min, ds_max)
        return df

    def getDataFrame(self):
        return self.df

    def predict(self, last_date = None):
